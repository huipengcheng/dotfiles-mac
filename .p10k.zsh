# Generated by Powerlevel10k configuration wizard on 2022-04-27 at 20:04 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_GO_VERSION_VISUAL_IDENTIFIER_EXPANSION='via ﳑ'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_JAVA_VERSION_VISUAL_IDENTIFIER_EXPANSION='via '
